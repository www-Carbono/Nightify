...
const Header: React.FC = () => {
  return (
<header className='flex flex-col items-center justify-center text-center mt-10'>
  <Image
    src={headerLogo}
    width={200}
    height={200}
  ...
  <h2 className='subtitle'>Transforma tu Música Favorita con Nightify: Elevando Tu Experiencia Musical a un Nivel Nightcore.</h2>
